...
import { User, Building2, Bell, CreditCard, Shield, Save, Globe, Loader2, ExternalLink, Copy, Check, CheckCircle, X, Eye, EyeOff, Lock } from 'lucide-react'
              ...
              <div className="max-w-md">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 pr-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-accent"
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2.5 bg-brand-navy text-white rounded-lg hover:bg-brand-dark disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {changingPassword ? (
                      <>
                        <Loader2 className="w-5 h-5 animate-spin" />
